      ...
      {isOpen && (
        <>
          ...
          <div className="
            ...
            bottom-4 left-4 right-4 h-[50vh] rounded-lg
            /* Desktop: bottom-right corner */
            sm:inset-auto sm:bottom-6 sm:right-6 sm:w-full sm:max-w-md sm:h-[500px] sm:max-h-[80vh] sm:rounded-lg
          ">
            {/* Chat Header */}
            <div className="bg-vasc-navy text-white p-4 rounded-t-lg flex justify-between items-center flex-shrink-0">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="text-center text-gray-500 mt-8">
                  <svg className="h-12 w-12 mx-auto mb-3 text-vasc-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                  <p className="text-sm">Hello! I&apos;m here to help you learn about Achiever Social&apos;s Club.</p>
                  <p className="text-xs mt-2">Ask me about membership, events, benefits, or anything else!</p>
                </div>
              ) : (
                ...
                <div className="flex justify-start">
                  <div className="bg-gray-100 p-3 rounded-lg">
                    <div className="flex space-x-1">
                      ...
                      <div className="w-2 h-2 bg-vasc-orange rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                      <div className="w-2 h-2 bg-vasc-orange rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                    </div>
                  </div>
                </div>
              )}
